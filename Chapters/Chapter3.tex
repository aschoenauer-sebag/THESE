...
For each condition group, Mitocheck selected hit genes were ordered according to their global distance to this group experiments (as described in section~\ref{sec:other_analyses}). The list of ordered genes for each condition group can be found in the Supplementaries, folder "Gene ranks".

A first result from these lists is the index of known drug targets, as can be seen in table~\ref{target_index}.
...
1 & HPGDS & 577\\
1 & TUBB2A & 548\\
1 & TUBB4A & over 1,000\\%1970
1 & TUBB4B & 416\\
1 & TUBB6 & 987\\%

2 & BCL2 & 389\\
2 & TUBB2A & 466\\
2 & TUBB4A & over 1,000\\%2005
2 & TUBB4B & 317\\
2 & TUBB6 & over 1,000\\%1241
