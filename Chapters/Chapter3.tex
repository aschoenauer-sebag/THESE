...
Finally, data should be persistent, which demands time, fundings, and incentive.  %\paragraph*{}
...
\begin{tabular}{|L{4cm}|l|l|L{1.4cm}|L{1.4cm}|}
\hline
...
%whereas it is not for other conditions. 
