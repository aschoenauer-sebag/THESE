...
%However, there is never a single paradigm to look at a specific
%dataset. To go further, most datasets should be treated as a
%scientific resource to their parent laboratory and to the community,
%rather than a one-article commitment. 
...
\textcolor{red}{\bf [*** I guess I am not entirely convinced. Of
...
to problems in nuclear stability. Accumulations in \textit{Metaphase Alignment Problems
  (MAP)} and \texit{Prometaphase} are observed if the mitotic spindle
